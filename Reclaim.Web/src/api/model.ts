...
export class AccountClient extends ApiBase {
    ...
    ErrorCode.AccountRequiresIdentityProviderLocal<br><br><b>Anonymous access allowed</b>
    */
    ...
    ErrorCode.AccountCredentialsExpired
    ErrorCode.AccountEmailAddressNotConfirmed
    ErrorCode.AccountRequiresIdentityProviderGoogle<br><br><b>Anonymous access allowed</b>
    */
    ...
    ErrorCode.AccountStatusInvalidForOperation<br><br><b>Requires an authenticated account with any role</b>
    */
    ...
    ErrorCode.AccountDoesNotExist<br><br><b>Requires an authenticated account with the Administrator role</b>
    ...
    */
    ...
    <br><br><b>Requires an authenticated account with the Administrator role</b>
    */
    authenticated(): Promise<Account[]> {
        let url_ = this.baseUrl + "/accounts/authenticated";
        url_ = url_.replace(/[?&]$/, "");
    ...
    */
    get(uniqueID: string): Promise<Account> {
        let url_ = this.baseUrl + "/accounts/{uniqueID}";
    ...
    */
    getAdministrators(): Promise<Administrator[]> {
        let url_ = this.baseUrl + "/accounts/administrators";
        url_ = url_.replace(/[?&]$/, "");
    ...
    ErrorCode.AccountMagicUrlTokenExpired<br><br><b>Anonymous access allowed</b>
    ...
    */
    ...
    ErrorCode.AccountDoesNotExist<br><br><b>Requires an authenticated account with any role</b>
    */
    me(): Promise<Account> {
    ...
    ErrorCode.AccountPasswordUsedPreviously<br><br><b>Anonymous access allowed</b>
    ...
    */
    ...
    ErrorCode.AccountRoleInvalidForOperation
    ErrorCode.AccountRequiresIdentityProviderLocal
    ErrorCode.AccountRoleInvalidForOperation<br><br><b>Anonymous access allowed</b>
    ...
    */
    ...
    ErrorCode.DocumentTypeNotSupported<br><br><b>Requires an authenticated account with any role</b>

    @param file (optional) 
    */
    uploadAvatar(file?: FileParameter | null | undefined): Promise<string> {
        let url_ = this.baseUrl + "/accounts/avatar";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUploadAvatar(response: Response): Promise<string> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class ClaimClient extends ApiBase {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    <br><br><b>Requires an authenticated account with any role</b>
    */
    ...
    ErrorCode.ClaimDoesNotExistForAccount<br><br><b>Requires an authenticated account with any role</b>

    @param uniqueID The claims's public unique ID
    */
    getClaim(uniqueID: string): Promise<Claim> {
        let url_ = this.baseUrl + "/claims/{uniqueID}";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
        url_ = url_.replace(/[?&]$/, "");
    ...
    @param uniqueID The claims's public unique ID
    */
    createChat(uniqueID: string): Promise<Chat> {
        let url_ = this.baseUrl + "/claims/{uniqueID}/chats";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateChat(response: Response): Promise<Chat> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = Chat.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
    ...
    ErrorCode.ChatNotAssociatedToClaim<br><br><b>Requires an authenticated account with any role</b>

    @param uniqueID The claim's public unique ID

    @param chatUniqueID The chat's public unique ID
    */
    getChat(uniqueID: string, chatUniqueID: string): Promise<Chat> {
        let url_ = this.baseUrl + "/claims/{uniqueID}/chats/{chatUniqueID}";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
        if (chatUniqueID === undefined || chatUniqueID === null)
            throw new Error("The parameter 'chatUniqueID' must be defined.");
        url_ = url_.replace("{chatUniqueID}", encodeURIComponent("" + chatUniqueID));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetChat(response: Response): Promise<Chat> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    ErrorCode.DocumentOpenAIQueryFailed<br><br><b>Requires an authenticated account with any role</b>
    ...
    */
    queryClaim(uniqueID: string, chatUniqueID: string, question?: string | undefined): Promise<Chat> {
        let url_ = this.baseUrl + "/claims/{uniqueID}/chats/{chatUniqueID}?";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processQueryClaim(_response);
        });
    }

    protected processQueryClaim(response: Response): Promise<Chat> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    @param file (optional) 
    */
    uploadDocument(uniqueID: string, lastModifiedTimestamp?: moment.Moment | undefined, file?: FileParameter | null | undefined): Promise<Document> {
        let url_ = this.baseUrl + "/claims/{uniqueID}/documents?";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
        if (lastModifiedTimestamp === null)
            ...
            url_ += "lastModifiedTimestamp=" + encodeURIComponent(lastModifiedTimestamp ? "" + lastModifiedTimestamp.toISOString() : "") + "&";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUploadDocument(response: Response): Promise<Document> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    ErrorCode.DocumentDownloadFromAzureFailed<br><br><b>Requires an authenticated account with any role</b>

    @param uniqueID The claims's public unique ID

    @param documentUniqueID The document's public unique ID
    */
    downloadDocument(uniqueID: string, documentUniqueID: string): Promise<FileResponse> {
        let url_ = this.baseUrl + "/claims/{uniqueID}/documents/{documentUniqueID}";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
    ...
    protected processDownloadDocument(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
    ...
    ErrorCode.DocumentDoesNotExist<br><br><b>Requires an authenticated account with any role</b>

    @param uniqueID The claims's public unique ID

    @param documentUniqueID The document's public unique ID
    */
    tombstoneDocument(uniqueID: string, documentUniqueID: string): Promise<void> {
        let url_ = this.baseUrl + "/claims/{uniqueID}/documents/{documentUniqueID}";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processTombstoneDocument(_response);
        });
    }

    protected processTombstoneDocument(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class ContentClient extends ApiBase {
    ...
    <br><br><b>Anonymous access allowed</b>
...
export class CustomerClient extends ApiBase {
    ...
    */
    ...
    ErrorCode.AccountPasswordDoesNotMeetMinimumComplexity
    ErrorCode.<br><br><b>Requires an authenticated account with the Administrator role</b>
    ...
    */
    ...
    ErrorCode.AccountPasswordDoesNotMeetMinimumComplexity<br><br><b>Anonymous access allowed</b>

    @param dto A CustomerRegistration DTO
    */
    register(dto: CustomerRegistration): Promise<Customer> {
        let url_ = this.baseUrl + "/customers/registration";
        url_ = url_.replace(/[?&]$/, "");
    ...
    ErrorCode.CustomerDoesNotExist<br><br><b>Requires an authenticated account with any role</b>
    */
    getCustomer(uniqueID: string): Promise<Customer> {
        let url_ = this.baseUrl + "/customers/{uniqueID}";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
        url_ = url_.replace(/[?&]$/, "");
    ...
    ErrorCode.CustomerCodeAlreadyExists
    ErrorCode.AccountPasswordDoesNotMeetMinimumComplexity
    ErrorCode.AccountEmailAddressAlreadyExists<br><br><b>Requires an authenticated account with the Administrator role</b>
    ...
    */
    ...
    ErrorCode.CustomerDoesNotExist<br><br><b>Requires an authenticated account with the Administrator role</b>
    */
    getClaimsByCustomer(uniqueID: string): Promise<Claim[]> {
        let url_ = this.baseUrl + "/customers/{uniqueID}/claims";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
        url_ = url_.replace(/[?&]$/, "");
...
export class DashboardClient extends ApiBase {
    private http: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> };
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    <br><br><b>Requires an authenticated account with the Administrator role</b>
    */
    getAdministrator(): Promise<AdministratorDashboard> {
        let url_ = this.baseUrl + "/dashboard/administrator";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetAdministrator(_response);
        });
    }

    protected processGetAdministrator(response: Response): Promise<AdministratorDashboard> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    <br><br><b>Requires an authenticated account with the Customer role</b>
    */
    getCustomer(): Promise<CustomerDashboard> {
        let url_ = this.baseUrl + "/dashboard/customer";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetCustomer(response: Response): Promise<CustomerDashboard> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    <br><br><b>Requires an authenticated account with the Investigator role</b>
    */
    getInvestigator(): Promise<InvestigatorDashboard> {
        let url_ = this.baseUrl + "/dashboard/investigator";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetInvestigator(response: Response): Promise<InvestigatorDashboard> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class InvestigatorClient extends ApiBase {
    ...
    <br><br><b>Requires an authenticated account with any role</b>
    */
    getAll(): Promise<Investigator[]> {
        let url_ = this.baseUrl + "/investigators";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAll(response: Response): Promise<Investigator[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    */
    create(dto: InvestigatorCreateOrUpdate): Promise<Investigator> {
        let url_ = this.baseUrl + "/investigators";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: Response): Promise<Investigator> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    ErrorCode.InvestigatorDoesNotExist<br><br><b>Requires an authenticated account with any role</b>

    @param uniqueID The investigator's unique public ID
    */
    get(uniqueID: string): Promise<Investigator> {
        let url_ = this.baseUrl + "/investigators/{uniqueID}";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGet(response: Response): Promise<Investigator> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    */
    update(uniqueID: string, dto: InvestigatorCreateOrUpdate): Promise<Investigator> {
        let url_ = this.baseUrl + "/investigators/{uniqueID}";
        if (uniqueID === undefined || uniqueID === null)
            throw new Error("The parameter 'uniqueID' must be defined.");
        url_ = url_.replace("{uniqueID}", encodeURIComponent("" + uniqueID));
    ...
    protected processUpdate(response: Response): Promise<Investigator> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class JobClient extends ApiBase {
    ...
    */
    ...
    ErrorCode.ScheduledJobTimeout<br><br><b>Requires an authenticated account with the Administrator role</b>
    */
    runPendingJobs(): Promise<void> {
        let url_ = this.baseUrl + "/jobs/runpending";
        url_ = url_.replace(/[?&]$/, "");
...
export class StatusClient extends ApiBase {
    ...
    */
    ...
    ErrorCode.Unhandled<br><br><b>Anonymous access allowed</b>
    */
    error(): Promise<void> {
        ...
        if (data) {
            ...
            if (data.documents) {
                ...
                for (let i = 0; i < data.documents.length; i++) {
                    ...
                    this.documents[i] = item && !(<any>item).toJSON ? new Document(item) : <Document>item;
                }
            }
...
export class Chat implements IChat {
    ...
    startedTimestamp!: moment.Moment;
        ...
        if (data) {
            ...
            if (data.messages) {
                ...
                for (let i = 0; i < data.messages.length; i++) {
                    ...
                    this.messages[i] = item && !(<any>item).toJSON ? new ChatMessage(item) : <ChatMessage>item;
                }
            }
        }
        if (!data) {
    ...
    init(_data?: any) {
        if (_data) {
            this.uniqueID = _data["uniqueID"];
            this.claimExternalID = _data["claimExternalID"];
            this.type = _data["type"];
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["uniqueID"] = this.uniqueID;
        data["claimExternalID"] = this.claimExternalID;
        data["type"] = this.type;
...
export class ChatMessage implements IChatMessage {
    ...
    chatRole!: ChatRole;
    text!: string;
    submittedTimestamp!: moment.Moment;
        ...
        if (data) {
            ...
            if (data.citations) {
                ...
                for (let i = 0; i < data.citations.length; i++) {
                    let item = data.citations[i];
                    this.citations[i] = item && !(<any>item).toJSON ? new Citation(item) : <Citation>item;
                }
            }
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            this.uniqueID = _data["uniqueID"];
            this.chatRole = _data["chatRole"];
            this.text = _data["text"];
            this.submittedTimestamp = _data["submittedTimestamp"] ? moment(_data["submittedTimestamp"].toString()) : <any>undefined;
            this.receivedTimestamp = _data["receivedTimestamp"] ? moment(_data["receivedTimestamp"].toString()) : <any>undefined;
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["uniqueID"] = this.uniqueID;
        data["chatRole"] = this.chatRole;
        data["text"] = this.text;
        data["submittedTimestamp"] = this.submittedTimestamp ? this.submittedTimestamp.toISOString() : <any>undefined;
        data["receivedTimestamp"] = this.receivedTimestamp ? this.receivedTimestamp.toISOString() : <any>undefined;
...
export class Citation implements ICitation {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.boundingBoxes = _data["boundingBoxes"];
            this.fileName = _data["fileName"];
            this.documentUniqueID = _data["documentUniqueID"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["boundingBoxes"] = this.boundingBoxes;
        data["fileName"] = this.fileName;
        data["documentUniqueID"] = this.documentUniqueID;
        return data;
    }
}
...
export enum ErrorCode {
    ...
    CustomerDoesNotExistForAccount = "CustomerDoesNotExistForAccount",
    InvestigatorDoesNotExist = "InvestigatorDoesNotExist",
    InvestigatorDoesNotExistForAccount = "InvestigatorDoesNotExistForAccount",
    ...
    DocumentDoesNotExistForAccount = "DocumentDoesNotExistForAccount",
    ...
    DocumentNotAssociatedToClaim = "DocumentNotAssociatedToClaim",
    DocumentTextCouldNotBeExtracted = "DocumentTextCouldNotBeExtracted",
    DocumentOpenAIQueryNoResults = "DocumentOpenAIQueryNoResults",
    ChatDoesNotExist = "ChatDoesNotExist",
    ChatDoesNotExistForAccount = "ChatDoesNotExistForAccount",
    ClaimDoesNotExist = "ClaimDoesNotExist",
    ClaimDoesNotExistForAccount = "ClaimDoesNotExistForAccount",
}
